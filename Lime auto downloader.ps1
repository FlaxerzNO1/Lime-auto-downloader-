...
$dosyalar = @(
        ...
        @{ Url = "https://privazer.com/ShellBagAnalyzerCleaner.exe"; Ad = "ShellBagAnalyzerCleaner.exe" }
        ...
        @{ Url = "https://www.nirsoft.net/utils/webbrowserdownloadsview.zip"; Ad = "WebBrowserDownloadsView.zip" }
